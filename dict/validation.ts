...
const ApiBODYDATAKeys: string[] = ['TopicId', 'TopicName', 'Qid', 'Question', 'option1', 'option2', 'option3', 'option4', 'Answer']
...
function modelApiBODYDATAFromJsonContent(name: string, value: any, knownKeys: Record<string, boolean> = {}): Api.BODYDATA {
	...
	const result: Api.BODYDATA = {
		...
		'TopicName': allowUndefined(stringFromJson)(`${name}.TopicName`, value['TopicName']),
		'Qid': allowUndefined(stringFromJson)(`${name}.Qid`, value['Qid']),
...
function modelApiBODYDATAToJsonContent(name: string, value: Api.BODYDATA, knownKeys: Record<string, boolean> = {}): ToJson<Api.BODYDATA> {
	...
	const result: ToJson<Api.BODYDATA> = {
		...
		'TopicName': allowUndefined(stringToJson)(`${name}.TopicName`, value['TopicName']),
		'Qid': allowUndefined(stringToJson)(`${name}.Qid`, value['Qid']),
